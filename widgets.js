...
const CategoryView = new Lang.Class({
    ...
    _setupUi: function() {
        ...
        this._container_table_layout = this._container.layout_manager;

        this._container_table_layout.pack(this.separator, 1, 0);

        this._container_table_layout.pack(this._layout, 2, 0);
    ...
    setupSidebar: function() {
        ...
        this._container_table_layout.pack(this.categorySwitcher.actor, 0, 0);
    ...
    showPageSwitcher: function(show) {
        ...
        if (this._pageSwitcher.get_parent() == null) {
            this._container_table_layout.pack(this._pageSwitcher, 2, 1);
        }
...
const Grid = new Lang.Class({
    ...
    append: function(actor) {
        ...
        this._actor_layout = this.actor.layout_manager;

        this._actor_layout.pack(actor, col, this._currentRow);
